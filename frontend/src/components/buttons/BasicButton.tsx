...
interface BasicButtonProps extends React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>{
    color: "success" | "danger" | "dark" | "dark-light"
    children: ReactNode
}
