        ...
        >
            ...
            >
                <span className="flex ml-2 text-xl text-gray-300 group-hover:hidden">
                    {manga.title.length > 16 ? `${manga.title.substring(0, 16)}...` : manga.title}
                </span>
                <span className="flex mb-3 ml-2 text-gray-400 text-md group-hover:hidden">Ch. {manga.chapter}</span>
                <Transition
                    show={hovering}
                            ...
                            Reoverlay.showModal("UpdateMangaModal", {
                                ...
                                onConfirm: (updatedManga: Manga) => {
                                    mangasUpdate(updatedManga)
                                        ...
                                        .catch(() => {
                                            toast.error("There was an error while trying to update a manga");
                                        });
                                },
                            });
                        }}
                            ...
                            Reoverlay.showModal("ConfirmModal", {
                                onConfirm: () => {
                                    mangasDelete(manga.id)
                                        ...
                                        .catch(() => {
                                            toast.error("There was an error while trying to delete a manga");
                                        });
                                },
                            });
                        }}
